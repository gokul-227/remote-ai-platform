...
async def run_async_migrations() -> None:
    ...
    connectable = async_engine_from_config(
        ...
        # See app/core/database.py — defensive insurance against PgBouncer
        # transaction-mode poolers; harmless against a direct connection or
        # (what production actually uses) Supabase's session-mode pooler.
