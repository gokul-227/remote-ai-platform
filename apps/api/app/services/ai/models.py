...
class AIUsageLog(Base):
    ...
    prompt_key: Mapped[Optional[str]] = mapped_column(String(100), nullable=True, index=True)
    prompt_version: Mapped[Optional[str]] = mapped_column(String(30), nullable=True)
    provider_model: Mapped[Optional[str]] = mapped_column(String(150), nullable=True)
