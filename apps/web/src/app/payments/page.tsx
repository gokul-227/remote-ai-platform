      ...
      <div className="lg:col-span-6 space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="card-enterprise p-5 space-y-2 border-blue-200/60 dark:border-blue-900/40">
            ...
            <p className="text-2xl font-extrabold text-[#0866FF]">
        ...
        <div className="card-enterprise p-5 space-y-3 bg-slate-50/50 dark:bg-slate-900/40">
          <h3 className="text-xs font-bold uppercase tracking-wider text-slate-500 flex items-center gap-1.5">
            <HelpCircle className="h-3.5 w-3.5 text-[#0866FF]" /> Remote AI Platform Escrow Protection Lifecycle
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-2 text-xs">
            <div className="p-3 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
              <span className="font-bold text-[#0866FF] block mb-1">1. Fund Escrow</span>
