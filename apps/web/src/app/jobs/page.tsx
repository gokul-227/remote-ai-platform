          ...
          <div className="card-enterprise p-5 space-y-5">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
              <h3 className="font-bold text-slate-900 dark:text-white text-xs uppercase tracking-wider flex items-center gap-2">
                <SlidersHorizontal className="h-3.5 w-3.5 text-[#0866FF]" /> Filter Roles
              </h3>
              {activeFilterCount > 0 && (
                <button
                  type="button"
            ...
            <div className="space-y-4">
              ...
              <label className="flex items-center justify-between cursor-pointer p-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800/50">
                ...
                <input
                  ...
                  className="rounded text-[#0866FF] focus:ring-[#0866FF] h-4 w-4"
                />
              </label>
              ...
              return (
                <button
                  ...
                  className={`text-[11px] font-medium px-2.5 py-1 rounded-full border transition-all ${
                    active
                      ? "bg-[#0866FF] text-white border-[#0866FF] shadow-xs"
                      : "bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:border-[#0866FF]/40"
                  }`}
                >
                  {pill.label}
                </button>
