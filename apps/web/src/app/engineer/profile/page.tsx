      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/40 dark:to-indigo-950/40 border border-blue-200 dark:border-blue-800 rounded-xl p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="space-y-1">
          <h2 className="text-sm font-bold text-slate-900 flex items-center gap-1.5">
            <Sparkles className="h-4 w-4 text-[#0866FF]" /> Auto-build with AI Resume Import
          </h2>
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-5 px-4 py-8">
      ...
      <section className="card-enterprise overflow-hidden">
        ...
        <div className="h-36 relative overflow-hidden bg-gradient-to-br from-[#0866FF] via-[#1D6FE0] to-[#1D4ED8]">
        ...
        <div className="px-6 pb-6">
          ...
          <div className="mt-4 flex flex-wrap gap-4 text-sm text-slate-500">
            ...
            {profile.github_url && <a className="flex items-center gap-1.5 hover:text-[#0866FF] transition-colors" href={profile.github_url} target="_blank" rel="noreferrer"><Github className="h-4 w-4" />GitHub</a>}
            {profile.linkedin_url && <a className="flex items-center gap-1.5 hover:text-[#0866FF] transition-colors" href={profile.linkedin_url} target="_blank" rel="noreferrer"><Linkedin className="h-4 w-4" />LinkedIn</a>}
            {profile.portfolio_url && <a className="flex items-center gap-1.5 hover:text-[#0866FF] transition-colors" href={profile.portfolio_url} target="_blank" rel="noreferrer"><ExternalLink className="h-4 w-4" />Portfolio</a>}
          </div>
          ...
          {!viewingOther && (
            <section className="card-enterprise p-6">
              ...
              <div className="flex items-center gap-3">
                ...
                {profile.resume_url && <a className="text-sm text-[#0866FF] hover:underline flex items-center gap-1" href={profile.resume_url} target="_blank" rel="noreferrer"><ExternalLink className="h-3.5 w-3.5" />View resume</a>}
              </div>
            </section>
          )}
        </main>
