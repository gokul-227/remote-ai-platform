    ...
    >
      <div className="p-5">
        <div className="flex items-start gap-3">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-slate-100 bg-white text-xl font-black text-[#0866FF] shadow-sm overflow-hidden">
            {company.logo_url ? (
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-1.5">
              <h2 className="truncate text-sm font-semibold text-slate-900 group-hover:text-[#0866FF]">
                {company.name}
              </h2>
              {company.is_verified && (
                <ShieldCheck className="h-3.5 w-3.5 shrink-0 text-[#0866FF]" aria-label="Verified" />
              )}
            </div>
        ...
        <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-3">
          ...
          <span className="flex items-center gap-1 text-xs font-semibold text-[#0866FF] opacity-0 transition-opacity group-hover:opacity-100 ml-auto">
