        ...
        <div className="px-6 pb-6">
          <div className="-mt-10 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
            ...
            <div className="flex items-end gap-4">
              <div className="flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl border-4 border-white bg-white text-3xl font-black text-[#0A66C2] shadow-md overflow-hidden">
                {company.logo_url ? (
              ...
              <div className="space-y-2">
                {jobs.slice(0, 6).map((job) => (
                  <Link
                    key={job.id}
                    href={`/jobs/${job.id}`}
                    className="flex items-center justify-between rounded-xl border border-slate-100 p-3.5 transition-colors hover:border-[#0A66C2] hover:bg-slate-50 group"
                  >
                    <div>
                      <p className="text-sm font-semibold text-slate-900 group-hover:text-[#0A66C2]">
                        {job.title}
                      </p>
                    ...
                    <ExternalLink className="h-3.5 w-3.5 text-slate-400 group-hover:text-[#0A66C2]" />
                  </Link>
                ))}
              </div>
            )}
