...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12 relative">
      {/* Background blobs */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-cyan-500/5 blur-[120px] rounded-full pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/3 w-[400px] h-[300px] bg-indigo-600/5 blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1">Sign in to your WorkMesh AI account</p>
        </div>
        ...
        <div className="card p-8 space-y-5">
          ...
          <div className="relative flex items-center gap-3">
            ...
            <span className="text-xs text-slate-600 flex-shrink-0">or continue with email</span>
            <div className="flex-1 h-px bg-white/6" />
          </div>
