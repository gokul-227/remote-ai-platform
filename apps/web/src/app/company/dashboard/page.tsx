  ...
  return (
    <div className="max-w-7xl mx-auto py-6 px-4 space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 p-6 text-white">
        <div className="absolute inset-0 opacity-10" style={{ backgroundImage: "radial-gradient(circle at 70% 30%, #818cf8 0%, transparent 60%)" }} />
        <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-bold uppercase tracking-wider text-indigo-300 border border-indigo-500/40 rounded-full px-2.5 py-0.5">Hiring Command Center</span>
              {needsAction > 0 && (
          ...
          <div className="flex items-center gap-2 shrink-0">
            <Link href="/jobs/new">
              <Button size="sm" className="bg-indigo-600 hover:bg-indigo-700 border-transparent text-white" icon={<PlusCircle className="h-3.5 w-3.5" />}>
                Post Position
              </Button>
            </Link>
