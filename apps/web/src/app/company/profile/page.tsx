  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-6">
      ...
      <div className="card-enterprise overflow-hidden">
        <div className="h-36 relative overflow-hidden bg-gradient-to-br from-indigo-900 via-slate-900 to-[#0A66C2]">
        ...
        <div className="px-6 pb-6">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 -mt-12 mb-4">
            <div className="flex items-end gap-4">
              <div className="h-24 w-24 rounded-2xl bg-white dark:bg-slate-800 border-4 border-white dark:border-slate-800 shadow-md flex items-center justify-center text-3xl font-black text-[#0A66C2] overflow-hidden shrink-0">
                {profile.logo_url ? (
          ...
          <div className="flex flex-wrap gap-4 text-xs text-slate-500 dark:text-slate-400 mb-4">
            ...
            {profile.website && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-1.5 text-[#0A66C2] hover:underline font-semibold transition-colors"
              >
            ...
            {jobsQuery.isLoading ? (
              ...
              <div className="space-y-2.5">
                {jobs.slice(0, 6).map((job) => (
                  <div
                    key={job.id}
                    className="flex items-center justify-between p-3.5 rounded-xl border border-slate-100 dark:border-slate-800 hover:border-[#0A66C2] transition-colors"
                  >
                    <div>
                    ...
                    <div className="flex items-center gap-2">
                      <Link href={`/jobs/${job.id}`} className="text-xs text-[#0A66C2] hover:underline font-semibold flex items-center gap-1">
