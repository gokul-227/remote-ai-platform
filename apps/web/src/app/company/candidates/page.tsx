...
function CompanyCandidatesPageContent() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8 space-y-6">
      {/* Header */}
      <div className="card-enterprise p-6 bg-gradient-to-r from-white via-[#F5F9FF]/30 to-white dark:from-slate-900 dark:to-slate-900 border-l-4 border-l-[#0866FF] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      ...
      <section className="card-enterprise p-5 space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-xs font-bold text-slate-900 dark:text-white uppercase tracking-wider flex items-center gap-1.5">
            <Filter className="h-3.5 w-3.5 text-[#0866FF]" /> Talent Filter Controls
          </h2>
        </div>
        ...
        <div className="grid gap-3 md:grid-cols-2">
          ...
          <label className="flex items-center gap-2 text-xs font-semibold text-slate-700 dark:text-slate-300 cursor-pointer">
            <input
              ...
              className="rounded border-slate-300 text-[#0866FF] focus:ring-[#0866FF] h-4 w-4"
            />
            Open to work only
          </label>
        </div>
                ...
                >
                  ...
                  <div className="min-w-[180px] flex-1 basis-64">
                    <Link
                      ...
                      className="font-semibold text-slate-900 dark:text-white text-sm hover:text-[#0866FF] transition-colors inline-flex items-center gap-1"
                    >
                      {displayName}
